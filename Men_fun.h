...
#include <stdio.h>
#include <gtk/gtk.h>
#include "Voiture_fun.h"
#include "Client_fun.h"
#include "Location_fun.h"
...
void LocationVoitures(GtkWidget *widget,gpointer windo){
    ...
    g_signal_connect(button[0],"clicked",G_CALLBACK(visualiser),(gpointer)window);
    button[1]= gtk_button_new_with_label("Louer voiture");
    g_signal_connect(button[1],"clicked",G_CALLBACK(Louer_Voiture),(gpointer)window);
    button[2]= gtk_button_new_with_label("Retourner Voiture");
    g_signal_connect(button[2],"clicked",G_CALLBACK(Retourner_Voiture),(gpointer)window);
    button[3]= gtk_button_new_with_label("Modifier contrat");
    g_signal_connect(button[3],"clicked",G_CALLBACK(modifierloca),(gpointer)window);
    button[4]= gtk_button_new_with_label("Supprimer contrat");
    g_signal_connect(button[4],"clicked",G_CALLBACK(Suprimaloca),(gpointer)window);
...
void GestionClient(GtkWidget *widget,gpointer windo){
    ...
    gtk_window_set_icon_from_file(GTK_WINDOW(window4),"logo.png",NULL);
    ...
    g_signal_connect(button[0],"clicked",G_CALLBACK(ListClient),(gpointer)window4);
    button[1]=gtk_button_new_with_label("Ajouter client");
    g_signal_connect(button[1],"clicked",G_CALLBACK(AjoutClient),(gpointer)window4);
    button[2]=gtk_button_new_with_label("Modifier client");
    g_signal_connect(button[2],"clicked",G_CALLBACK(modifier2),(gpointer)window4);
    button[3]=gtk_button_new_with_label("Supprimer client");
    g_signal_connect(button[3],"clicked",G_CALLBACK(Supprimer2),(gpointer)window4);
    button[4]=gtk_button_new_with_label("Retour");
